	...
	function pre_draw_smarty() {
		...
		switch ($this->panel_type) {
			...
			case "ERROR":
				...
				if ($debugmsg) {
					//if ($debugmsg && $this->query->reportico_ajax_called) {
					//if (true) {
		...
		switch ($anal["action"]) {
			...
			case "assg":
				...
				if ($updates["AssignStyleFgColor"]) {
					$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'color', '" . $updates["AssignStyleFgColor"] . "');";
				}

				if ($updates["AssignStyleBgColor"]) {
					$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'background-color', '" . $updates["AssignStyleBgColor"] . "');";
				}

				if ($updates["AssignStyleFontName"]) {
					$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'font-family', '" . $updates["AssignStyleFontName"] . "');";
				}

				if ($updates["AssignStyleFontSize"]) {
					$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'font-size', '" . $updates["AssignStyleFontSize"] . "');";
				}

				if ($updates["AssignStyleWidth"]) {
					$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'width', '" . $updates["AssignStyleWidth"] . "');";
				}
				...
				if ($updates["AssignStyleFontStyle"] && $updates["AssignStyleFontStyle"] != "NONE") {
					...
					if ($updates["AssignStyleFontStyle"] == "BOLD" || $updates["AssignStyleFontStyle"] == "BOLDANDITALIC") {
						if ($updates["AssignStyleFontStyle"]) {
							$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'font-weight', 'bold');";
						}
					}

					if ($updates["AssignStyleFontStyle"] == "ITALIC" || $updates["AssignStyleFontStyle"] == "BOLDANDITALIC") {
						if ($updates["AssignStyleFontStyle"]) {
							$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'font-style', 'italic');";
						}
					}

					if ($updates["AssignStyleFontStyle"] == "NORMAL") {
						if ($updates["AssignStyleFontStyle"]) {
							$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'font-style', 'normal');";
						}
					}
					...
					if ($updates["AssignStyleFontStyle"] == "UNDERLINE") {
						if ($updates["AssignStyleFontStyle"] == "UNDERLINE") {
							if ($updates["AssignStyleFontStyle"]) {
								$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'text-decoration', 'underline');";
							}
						}
					}
					...
					if ($updates["AssignStyleFontStyle"] == "OVERLINE") {
						if ($updates["AssignStyleFontStyle"]) {
							$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'text-decoration', 'overline');";
						}
					}

					if ($updates["AssignStyleFontStyle"] == "BLINK") {
						if ($updates["AssignStyleFontStyle"]) {
							$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'text-decoration', 'blink');";
						}
					}

					if ($updates["AssignStyleFontStyle"] == "STRIKETHROUGH") {
						if ($updates["AssignStyleFontStyle"]) {
							$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'text-decoration', 'line-through');";
						}
					}
				...
				if (!$updates["AssignStyleBorderStyle"] || $updates["AssignStyleBorderStyle"] == "NOBORDER") {
					...
					if ($updates["AssignStyleBorderSize"]) {
						$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'border-width', '" . $updates["AssignStyleBorderSize"] . "');";
					}

					if ($updates["AssignStyleBorderColor"]) {
						$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'border-color', '" . $updates["AssignStyleBorderColor"] . "');";
					}
				...
				if ($updates["AssignStylePadding"]) {
					$styletxt .= "apply_style('" . $updates["AssignStyleLocType"] . "', 'padding', '" . $updates["AssignStylePadding"] . "');";
				}
