...
{if !$REPORTICO_AJAX_PRELOADED}
{literal}
<script type="text/javascript" src="{/literal}{$JSPATH}{literal}/select2/js/reporticoSelect2.min.js"></script>
<script type="text/javascript" src="{/literal}{$JSPATH}{literal}/jquery.dataTables.js"></script>
{/literal}
<LINK id="PRP_StyleSheet_s2" REL="stylesheet" TYPE="text/css" HREF="{$JSPATH}/select2/css/reporticoSelect2.min.css">
...
{if $SHOW_HIDE_DROPDOWN_MENU == "show" && $DROPDOWN_MENU_ITEMS}
            <!--a style="display:inline-block" href="#" class="navbar-brand reportico-dropdown-brand">{$MENU_TITLE} :</a-->
{/if}
            </div>
...
{section name=menu loop=$DROPDOWN_MENU_ITEMS}
                    <li class="dropdown nav-item reportico-dropdown-listitem"><a class="dropdown-toggle nav-link reportico-dropdown-link" data-toggle="dropdown" href="#">{$DROPDOWN_MENU_ITEMS[menu].title}<span class="caret"></span></a>
...
{if isset($DROPDOWN_MENU_ITEMS[menu].items[menuitem].reportname)}
                        <li ><a class="dropdown-item reportico-dropdown-item" href="{$RUN_REPORT_URL}&project={$DROPDOWN_MENU_ITEMS[menu].items[menuitem].project}&xmlin={$DROPDOWN_MENU_ITEMS[menu].items[menuitem].reportfile}">{$DROPDOWN_MENU_ITEMS[menu].items[menuitem].reportname}</a></li>
{/if}
{/section}
                    </ul>
                    </li>
...
{if ($SHOW_DESIGN_BUTTON)}
                <li style="display: inline-block"><input class="span {$BOOTSTRAP_STYLE_ADMIN_BUTTON}swAdminButton2" type="submit" name="submit_design_mode" value="{$T_DESIGN_REPORT}"></li>
{/if}
...
{if strlen($ADMIN_MENU_URL)>0} 
              <li class="nav-item" style="display:inline-block">
                    <a class="nav-link swAdminButton2 reportico-dropdown-link" href="{$ADMIN_MENU_URL}">{$T_ADMIN_MENU}</a>
              </li>
{/if}
{/if}
{if $SHOW_PROJECT_MENU_BUTTON}
              <li class="nav-item" style="display: inline-block">
                    <a class="nav-link swAdminButton2 reportico-dropdown-link" href="{$MAIN_MENU_URL}">{$T_PROJECT_MENU}</a>
              </li>
{/if}
{if $SHOW_LOGOUT}
                <li style="display: inline-block"> <input class="span {$BOOTSTRAP_STYLE_ADMIN_BUTTON}swAdminButton2" type="submit" name="logout" value="{$T_LOGOFF}"></li>
{/if}
</div>
</ul>
        </div>
...
{$T_REPORT_FILE} <input type="text" name="xmlout" id="swPrpSaveFile" value="{$XMLFILE}"> <input type="submit" class="{$BOOTSTRAP_STYLE_PRIMARY_BUTTON} swPrpSaveButton" type="submit" name="submit_xxx_SAVE" value="{$T_SAVE}">
    				    ...
    				    <li  style="display: inline-block"><input type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareMiniMaintain swMiniMaintain" style="margin-top: 10px; margin-right: 30px" title="{$T_EDIT} {$T_EDITSQL}" id="submit_mainquerqury_SHOW" value="{$T_EDITSQL}" name="mainquerqurysqlt_QuerySql"></li>
    				    <li style="display: inline-block"><input type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareMiniMaintain swMiniMaintain" style="margin-top: 10px; margin-right: 30px" title="{$T_EDIT} {$T_EDITCOLUMNS}" id="submit_mainquerquryqcol_SHOW" value="{$T_EDITCOLUMNS}" name="mainquerquryqcol_ANY"></li>
    				    <li style="display: inline-block"><input type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareMiniMaintain swMiniMaintain" style="margin-top: 10px; margin-right: 30px" title="{$T_EDIT} {$T_EDITASSIGNMENT}" id="submit_mainquerassg" value="{$T_EDITASSIGNMENT}" name="mainquerassg_ANY"></li>
    				    <li style="display: inline-block"><input type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareMiniMaintain swMiniMaintain" style="margin-top: 10px; margin-right: 30px" title="{$T_EDIT} {$T_EDITGROUPS}" id="submit_mainqueroutpgrps" value="{$T_EDITGROUPS}" name="mainqueroutpgrps_ANY"></li>
    				    <li style="display: inline-block"><input type="submit" class="{$BOOTSTRAP_STYLE_TOOLBAR_BUTTON}prepareMiniMaintain swMiniMaintain" style="margin-top: 10px; margin-right: 30px" title="{$T_EDIT} {$T_EDITGRAPHS}" id="submit_mainqueroutpgrph" value="{$T_EDITGRAPHS}" name="mainqueroutpgrph_ANY"></li>
...
{else}
                    <ul class="nav navbar-nav pull-right navbar-right">
{/if}
                            <li class="dropdown"><a class="dropdown-toggle reportico-dropdown-link" data-toggle="dropdown" href="#">{$T_SHOW}<span class="caret"></span></a>
