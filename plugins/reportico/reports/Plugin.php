...
//                        'tab' => 'Reports'
//                    ],
                    'reportico.reportico.manage_plugins' => ['tab' => 'Reportico', 'label' => 'Manage Reporting Plugins'],
                    'reportico.reports.reports' => ['tab' => 'Reportico', 'label' => 'Show custom reports'],
                ]
        ;
    }
    ...
    public function registerNavigation() {
        return [
            'reports' => [
                ...
                'permissions' => ['reportico.reports.reports'],
                'order' => 500,
            ]
        ];
    }
