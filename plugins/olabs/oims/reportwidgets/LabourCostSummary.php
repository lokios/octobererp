 ...
 */
class LabourCostSummary extends ReportWidgetBase {

    /**
     * @var string A unique alias to identify this widget.
     */
    protected $defaultAlias = 'labourCostSummary';
    ...
    public function defineProperties() {
        return [
            'title' => [
                'title' => 'Labour Cost Summary Report',
                'default' => 'Labour Cost Summary Report',
                'type' => 'string',
                'validationPattern' => '^.+$',
