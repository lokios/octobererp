...
class BuilderTableCreateOlabsOimsExpenseOnPcs extends Migration
{
    public function up()
    {
        Schema::create('olabs_oims_expense_on_pcs', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('olabs_oims_expense_on_pcs');
    }
}
