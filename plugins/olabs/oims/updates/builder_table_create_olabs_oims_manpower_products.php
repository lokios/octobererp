...
class BuilderTableCreateOlabsOimsManpowerProducts extends Migration
{
    public function up()
    {
        Schema::create('olabs_oims_manpower_products', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('olabs_oims_manpower_products');
    }
}
