...
UPDATE `olabs_oims_purchase_products`  set pre_tax_retail_price = unit_price;
UPDATE `olabs_oims_purchase_products`  set tax_percent = 0;
UPDATE `olabs_oims_purchase_products`  set total_tax = 0;
